...
public class user1 extends Thread {
	...
	private BigInteger user1_data = new BigInteger("35");
	BigInteger ki, c;
	private int n =3;
 ...
 //		System.out.println("hash sum" + hash_sum1);
	...
	//	System.out.println("Key: "+ ki);
		...
		// Produce Cipher text
		c = (ki.add(user1_data)).mod(M);
		
		System.out.println("Cipher-Text: "+ c);
		
		// increase data by 5
		user1_data = user1_data.add(new BigInteger("5"));
...
try{
	...
	ServerSocket server = new ServerSocket(5067);	
